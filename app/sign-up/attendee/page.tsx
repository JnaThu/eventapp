...
import { signUpAttendee } from '@/lib/actions/auth'

export default function AttendeeSignUpPage() {
  const [state, action, pending] = useActionState(signUpAttendee, undefined)
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm p-8">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Sign up to discover and follow dance events.
            </p>
          </div>
